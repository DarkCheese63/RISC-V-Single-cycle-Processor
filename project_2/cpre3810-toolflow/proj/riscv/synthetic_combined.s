...
_start:
    # --- GLOBAL SETUP ---
    # Initialize Stack Pointer (Required for CF tests later)
    lui sp, 0x10010     # sp = 0x10010000

    # =========================================================================
    # PART 1: BASE INSTRUCTION TESTS (Arithmetic, Logic, Memory)
    # =========================================================================
    
    # --- Setup Results Pointer ---
    lui s0, %hi(results)
    ...
    # =========================================================================
    # PART 2: CONTROL FLOW TESTS (Branches, Jumps, Functions)
    # =========================================================================
